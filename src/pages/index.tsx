  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to TestApp, your comprehensive backend solution for managing access to digital items. Facilitating ownership and sharing with unprecedented ease and security."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1513712230855-e5915b9d5ced?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxkaWdpdGFsJTIwaXRlbXN8ZW58MHx8fHwxNjk3OTAyMDI3fDA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
          ...
          <Box position="absolute" top="0" backgroundColor="rgba(0,0,0,0.6)" width="100%" py="2">
            <Text align="center" fontSize="sm" color="white">
              Photo by{' '}
              <Link
                href="https://unsplash.com/@katetrysh?utm_source=roq-generator&utm_medium=referral"
                isExternal
                color="teal.200"
              >{`Kate Trysh`}</Link>{' '}
              on{' '}
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to TestApp, your comprehensive backend solution for managing access to digital items. Facilitating ownership and sharing with unprecedented ease and security.`}
            </Text>
            <Box
